    ...
    <body>
        <div id="body-bg">
            ...
            <div id="pre-header" class="background-gray-lighter">
                <div class="container no-padding">
                    <div class="row hidden-xs">
                        <div class="col-sm-6 padding-vert-5" style="color:black;"portfoli>
                            <strong>Phone:</strong>&nbsp;1-800-123-4567
                        </div>
                        <div class="col-sm-6 text-right padding-vert-5" style="color:black;">                            
                            <strong>Email:</strong>&nbsp;yrchsl@gmail.com
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="logo">
                            <a href="index.html" title="">
                                <img src="assets/img/yog.png" alt="Logo" />
                            </a>
                        </div>
                        <!-- End Logo -->
                    </div>
            ...
            <div style="padding-top: 15px;">
                <marquee>IMPORTANT NOTICE</marquee> </div>
            <!-- Top Menu -->
                    ...
                    <div class="row">
                        <div class="col-md-8 no-padding">
                            <div class="visible-lg">
                                <ul id="hornavmenu" class="nav navbar-nav">
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <a href="">Parking Details</a>
                                            </li>
                                            <li>
                                                <a href="">Facilities In Vicinity</a>
                                            </li>
                                            <li>
                                                <a href="">Accounting (Admin)</a>
                                            </li>
                                    <!--        <li>
                                                <a href="">Carousels</a>
                                            </li>
                             ...
                             <!---       <li>
                                        <span class="fa-font ">services</span>
                                        <ul>
                                            <li>
                                                <a href="">Complaints</a>
                                            </li>
