                ...
                <div class="container background-white">
                    ...
                    <div class="row">
                        <div class="col-md-12 portfolio-group no-padding">
                            ...
                            <!-- End Portfolio Item -->
                            <!-- Portfolio Item -->
                            <div class="col-md-2 portfolio-item margin-bottom-40 design">
                                <div>
                                    <a href="#">
                                        <figure>
                            ...
                            <!-- End Portfolio Item -->
                            <!-- Portfolio Item -->
                            <div class="col-md-2 portfolio-item margin-bottom-40 video">
                                <div>
                                    <a href="#">
                                        <figure>
                            ...
                            <!-- End Portfolio Item -->
                            <!-- Portfolio Item -->
                            <div class="col-md-2 portfolio-item margin-bottom-40 code">
                                <div>
                                    <a href="#">
                                        <figure>
