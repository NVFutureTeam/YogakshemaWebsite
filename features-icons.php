            ...
            <div id="content">
                <div class="container background-white">
                    <div class="row margin-vert-40">
                        ...
                        <div class="col-md-9">
                            <!-- Icon Size -->
                            <h3 class="margin-bottom-20">Icon Size</h3>
                            <div class="row">
                                <div class="col-md-3">
                                    <p>
                                        <i class="fa fa-camera-retro fa-lg"></i>fa-lg</p>
                                    <p>
                                        <i class="fa fa-camera-retro fa-2x"></i>fa-2x</p>
                                    <p>
                                        <i class="fa fa-camera-retro fa-3x"></i>fa-3x</p>
                                    <p>
                                        <i class="fa fa-camera-retro fa-4x"></i>fa-4x</p>
                                    <p>
                                ...
                                <div class="col-md-9">
                                    ...
                                    <pre><code class="html">&lt;i class=&quot;fa fa-camera-retro fa-lg&quot;&gt;&lt;/i&gt; fa-lg
...
&lt;i class=&quot;fa fa-camera-retro fa-5x&quot;&gt;&lt;/i&gt; fa-5x</code></pre>
                            ...
                            <hr>
                            <!-- Fixed Width Icons -->
                            <h3 class="margin-bottom-20">Fixed Width Icons</h3>
                            <div class="row">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-9">
                                    <p>Use <code>fa-fw</code> to set icons at a fixed width. Great to use when different icon widths throw off alignment. Especially useful in things like nav lists &amp; list groups.</p>
...
&lt;/div&gt;</code></pre>
                            ...
                            <!-- End Fixed Width Icons -->
                            <hr>
                            <!-- List Icons -->
                            <h3 class="margin-bottom-20">List Icons</h3>
                            <div class="row">
                                <div class="col-md-3">
                                    <ul class="fa-ul">
                                        <li>
...
&lt;/ul&gt;</code></pre>
                            ...
                            <h3 class="margin-bottom-20">Rotated & Flipped</h3>
                            <div class="row">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <pre><code class="html">&lt;i class=&quot;fa fa-shield&quot;&gt;&lt;/i&gt; normal&lt;br&gt;
&lt;i class=&quot;fa fa-shield fa-rotate-90&quot;&gt;&lt;/i&gt; fa-rotate-90&lt;br&gt;
&lt;i class=&quot;fa fa-shield fa-rotate-180&quot;&gt;&lt;/i&gt; fa-rotate-180&lt;br&gt;
&lt;i class=&quot;fa fa-shield fa-rotate-270&quot;&gt;&lt;/i&gt; fa-rotate-270&lt;br&gt;
&lt;i class=&quot;fa fa-shield fa-flip-horizontal&quot;&gt;&lt;/i&gt; fa-flip-horizontal&lt;br&gt;
&lt;i class=&quot;fa fa-shield fa-flip-vertical&quot;&gt;&lt;/i&gt; icon-flip-vertical</code></pre>
                                </div>
                            </div>
                            <!-- End Rotated & Flipped Icons -->
                            <hr>
                            <!-- Stacked Icons -->
                            <h3 class="margin-bottom-20">Stacked Icons</h3>
                            <div class="row">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-9">
                                    <p>To stack multiple icons, use the <code>fa-stack</code> class on the parent, the <code>fa-stack-1x</code> for the regularly sized icon, and <code>fa-stack-2x</code> for the larger icon. <code>fa-inverse</code> can be used as
                                        an alternative icon color. You can even throw
                                        <a href="#larger">larger icon</a>classes on the parent to get further control of sizing.</p>
...
&lt;span class=&quot;fa-stack fa-lg&quot;&gt;
  ...
  &lt;i class=&quot;fa fa-ban fa-stack-2x text-danger&quot;&gt;&lt;/i&gt;
&lt;/span&gt;
&lt;p&gt;fa-ban on fa-camera&lt;/p&gt;</code></pre>
                                </div>
                            </div>
                            <!-- End Rotated & Flipped Icons -->
                            <hr>
